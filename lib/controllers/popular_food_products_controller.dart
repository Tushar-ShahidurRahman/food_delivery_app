...
int orderLimit(int orderNum) {
     if(orderNum < 0) {
       // note: I should not add this code here. It should go to UI.
       Get.snackbar('Order limit', 'You can not reduce more!', backgroundColor: AppColors.mainColor, colorText: Colors.white,);
       return 0;
     } else if (orderNum > 20){
       Get.snackbar('Order limit', 'You can not add more!', backgroundColor: AppColors.mainColor, colorText: Colors.white,);
       return 20;
     } else{
       return orderNum;
     }
...
void initProduct(CartController cart) {
     ...
     _inCartItem = 0;
     _cart = cart;
//     Then check the global variable if _inCartItem has any value stored or not.
}
